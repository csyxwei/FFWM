...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--display_freq', type=int, default=1400, help='frequency of showing training results on screen')
        ...
        parser.add_argument('--print_freq', type=int, default=2800, help='frequency of showing training results on console')
        ...
        parser.add_argument('--preload', action='store_true', help='preload data to memory')
